...
from .handlers import general, support  # Changed to relative import
...
def main() -> None:
    ...
    # application.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, support.handle_message))
